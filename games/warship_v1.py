...
while ((rangee_perso < 0 or rangee_perso > 9) or (colonne_perso < 0 or colonne_perso > 9)):
    print()
...
while ((rangee_perso2 < 0 or rangee_perso2 > 9) or (colonne_perso2 < 0 or colonne_perso2 > 9) or (rangee_perso2 == rangee_perso and colonne_perso2 == colonne_perso)):
    print()
...
while ((rangee_perso3 < 0 or rangee_perso3 > 9) or (colonne_perso3 < 0 or colonne_perso3 > 9) or (rangee_perso3 == rangee_perso and colonne_perso3 == colonne_perso) or (rangee_perso3 == rangee_perso2 and colonne_perso3 == colonne_perso2)):
    print()
...
while ((rangee_perso4 < 0 or rangee_perso4 > 9) or (colonne_perso4 < 0 or colonne_perso4 > 9) or (rangee_perso4 == rangee_perso and colonne_perso4 == colonne_perso) or (rangee_perso4 == rangee_perso2 and colonne_perso4 == colonne_perso2) or (rangee_perso4 == rangee_perso3 and colonne_perso4 == colonne_perso3)):
    print()
    print("Place ton navire sur la map, et ne le place pas sur un bateau déja existant.")
    print()
    print("Le bateau doit être placé sur des coordonnees allant de 0 à 9")
...
for tour in range(nbtour):
    ...
    if devine_rangee == boat_rangee and devine_colonne == boat_colonne:
        print()
        print('Tu a coulé un navire ennemi!')
        print()
        print('Bien joué matelot!')
        boat1 = 101
    ...
    if ((boat1==101) and (boat2==101) and (boat3==101) and (boat4==101)):
        print()
        print('Félicitations matelot, tu as coulé toute la flotte ennemie!')
        print()
        break
